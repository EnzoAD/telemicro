...
if ($method === 'post') {
    ...
    if (isset($input['nome_cliente']) && isset($input['cpf']) && isset($input['id_equipamento']) && isset($input['marca']) && isset($input['modelo']) && isset($input['id_defeito'])) {
        ...
        $sql = $pdo->prepare("INSERT INTO paciente (nome_cliente, cpf, id_equipamento, marca, modelo, id_defeito, id_causa, id_solucao) VALUES (:nome_cliente, :cpf, :id_equipamento, :marca, :modelo, :id_defeito, :id_causa, :id_solucao)");
